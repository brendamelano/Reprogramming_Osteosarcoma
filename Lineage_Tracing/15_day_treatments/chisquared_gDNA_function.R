...
for (barcode_id in unique(cis_diff_merged$barcode)) {
  ...
  test_total <- sum(cis_diff_merged$barcode_count_pf_1[cis_diff_merged$barcode != barcode_id],
                    cis_diff_merged$barcode_count_pf_2[cis_diff_merged$barcode != barcode_id],
                    cis_diff_merged$barcode_count_pf_3[cis_diff_merged$barcode != barcode_id])
